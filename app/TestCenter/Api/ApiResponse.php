...
class ApiResponse
{
	...
	public function unauthorizedPerm()
	{
		$response['code'] = ResponseCodes::RESPONSE_CODE_UNAUTHORIZED;
		$response['message'] = ResponseMessages::MESSAGE_PERM_UNAUTHORIZED;
	...
	public function fileProcessResponse(Array $errors = [], String $message=null)
	{
		$_message = $message == null ? ResponseMessages::MESSAGE_DEFAULT_VALIDATION_ERROR :
			$message;
